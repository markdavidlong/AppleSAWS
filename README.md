...
This code is being developed using Qt 6, with development work being done on Ubuntu Linux, but it should compile and run without problems on Windows and Mac.
